...
month2 = ['//*[@id="d_chart_search"]/div/div/div[3]/div[1]/ul/li[7]/span/label', '//*[@id="d_chart_search"]/div/div/div[3]/div[1]/ul/li[8]/span/label',
         '//*[@id="d_chart_search"]/div/div/div[3]/div[1]/ul/li[9]/span/label', '//*[@id="d_chart_search"]/div/div/div[3]/div[1]/ul/li[10]/span/label',
         '//*[@id="d_chart_search"]/div/div/div[3]/div[1]/ul/li[11]/span/label', '//*[@id="d_chart_search"]/div/div/div[3]/div[1]/ul/li[12]/span/label']

filelist = ['202007.csv', '202008.csv', '202009.csv', '202010.csv', '202011.csv', '202012.csv']

result_df = pd.DataFrame()
for j in range(len(month2)):
        ...
        time.sleep(2)
        ##월선택 1월클릭
        driver.find_element(By.XPATH, month2[j]).click()
        time.sleep(2)
        ## 장르선택 종합 클릭
